...
<template>
	<div class="container">
		<div class="-mx-6 md:mx-0">
			<div
				class="relative overflow-hidden bg-peach py-18 px-6 md:px-[58px] xl:py-[54px] xl:px-24 md:rounded-[15px] xl:flex xl:gap-[95px] xl:items-center transition group"
			>
				<div
