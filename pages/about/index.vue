...
import AppCardWithBanner from "~/components/shared/AppCardWithBanner.vue";
...
<template>
	<div class="relative">
        ...
        our clients. We’ve partnered with many startups, corporations, 
      ...
      "
					...
					>
						...
						<template #description>
							We are a crew of strategists,
							problem-solvers, and technologists.
							Every design is thoughtfully crafted
							from concept to launch, ensuring
							success in its given market. We are
							constantly updating our skills in a
							myriad of platforms.
							<br /><br />
							Our team is multi-disciplinary and
							we are not merely interested in form
							— content and meaning are just as
							important. We give great importance
							to craftsmanship, service, and
							prompt delivery. Clients have always
							been impressed with our high-quality
							outcomes that encapsulates their
			...
			<div class="container">
				<div class="-mx-6 md:mx-0 pb-30 xl:pb-40">
					...
					>
						...
						/>
						<template #description>
							As strategic partners in our
							clients’ businesses, we are ready to
							take on any challenge as our own.
							Solving real problems require
							empathy and collaboration, and we
							strive to bring a fresh perspective
							to every opportunity. We make design
							and technology more accessible and
							give you tools to measure success.
							<br /><br />We are visual
							storytellers in appealing and
							captivating ways. By combining
							business and marketing strategies,
							we inspire audiences to take action
		...
		<!-- overlay -->
		<div
			class="absolute w-full top-80 z-1 hidden xl:block"
		>
			<div class="container">
				<div
